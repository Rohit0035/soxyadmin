...
const recharg = lazy(() => import("./views/apps/services/Recharg"));
const dthRecharg = lazy(() => import("./views/apps/services/DthRecharg"));
const electricity = lazy(() => import("./views/apps/services/Electricity"));
const bookGas = lazy(() => import("./views/apps/services/BookGas"));
const creditCard = lazy(() => import("./views/apps/services/CreditCard"));
const broadband = lazy(() => import("./views/apps/services/Broadband"));
const waterBill = lazy(() => import("./views/apps/services/WaterBill"));
const municipality = lazy(() => import("./views/apps/services/Municipality"));
const fasTag = lazy(() => import("./views/apps/services/FasTag"));
const hospitalBill = lazy(() => import("./views/apps/services/HospitalBill"));
const cabletv = lazy(() => import("./views/apps/services/cabletv"));
